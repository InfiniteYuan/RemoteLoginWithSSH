...
* */
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Log.i("Debug", "nav_camera click");
        } else if (id == R.id.nav_gallery) {
            Log.i("Debug", "nav_gallery click");
        } else if (id == R.id.nav_slideshow) {
            Log.i("Debug", "nav_slideshow click");
        } else if (id == R.id.nav_manage) {
            Log.i("Debug", "nav_manage click");
            Intent intent = new Intent(MainActivity.this, ToolActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_share) {
            Log.i("Debug", "nav_share click");
        } else if (id == R.id.nav_send) {
            Log.i("Debug", "nav_send click");
        }
